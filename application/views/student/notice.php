    ...
    Settings
        ...
        <li class='dropdown user'>
            <a class='dropdown-toggle' data-toggle='dropdown' href='#'>
                ...
                <strong><?php echo $snum; ?></strong>
<!--                <img class="img-rounded" src="http://placehold.it/20x20/ccc/777"/>-->
                <b class='caret'></b>
            </a>
            <ul class='dropdown-menu'>
                <li>
                    <a href='<?= $base_url ?>BiShe/index.php/GDindex/editProfile' target="content">Edit Profile</a>
                </li>
                <li class='divider'></li>
                <li>
                    <a href="/">Sign out</a>
...
<div id='wrapper'>
    ...
    <a href='#'>Data</a>
            ...
            <li class='launcher'>
                <i class='icon-file-text-alt'></i>
                <a href="<?= $base_url ?>BiShe/index.php/DataController/queryData" target="content">Data</a>
            </li>
